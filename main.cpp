...
int main() {
    ...
    while(spr){
        ...
        cout << "6. Bucket Sort - Wersja z max 8 watkami" << endl;
        cout << "7. Zmien liczbe danych do posortowania" << endl;
        cout << "8. Sprawdz liczbe danych dla ktorych wykonywane jest sortowanie" << endl;
        cout << "0. Wyjscie" << endl;
